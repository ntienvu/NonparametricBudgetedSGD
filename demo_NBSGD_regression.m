...
[yyTrain, xxTrain]=libsvmread('data\eunite2001'); % regression
%[yyTrain, xxTrain]=libsvmread('data\abalone_scale'); % regression


% standard the outcome for regression
yyTrain=(yyTrain-mean(yyTrain))/std(yyTrain);
...
optimalLambda=100/length(yyTrain);


myflag=3; % myflag=2 indicates multi classification task
scheme_type='Projection'; %'Removal' or 'Projection'
mybeta=0.4;
loss_type='L2'; % 'L1','L2','Eps'
